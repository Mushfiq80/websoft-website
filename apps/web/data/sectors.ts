...
export const SECTORS: Sector[] = [
  ...
  },
  {
    ...
    relatedProjects: ["rri", "mushroom", "coxda", "hdf", "polycables"],
  },
  {
    id: "ai",
    name: "AI & Big Data",
  ...
  },
  {
    ...
    icon: "Cpu",
    color: "#534AB7",
    description: "Applied research, prototyping, and research data platforms — from IoT and data science to scientific journals and study portals.",
    features: [
      { title: "Applied R&D", desc: "Prototyping IoT, data-science and AI solutions for real-world problems", icon: "Cpu" },
      { title: "Research data platforms", desc: "Secure, user-based data portals for scientific and field research", icon: "BarChart3" },
      { title: "Scientific publishing", desc: "Journal and technical-publication platforms for research institutes", icon: "Radio" },
    ],
    visual: { label: "I-Soil R&D Platform", icon: "Cpu", image: "/images/projects/isoil-web.png" },
    relatedProjects: ["isoil", "dhdr", "rri", "lead-bigdata"],
  },
  {
    id: "erp-finance",
    name: "ERP & Finance",
    ...
    icon: "Database",
    color: "#7370D8",
    description: "Enterprise resource planning, financial management, and business process automation systems.",
    features: [
      { title: "ERP systems", desc: "Enterprise resource planning for operations and management", icon: "Building2" },
      { title: "Finance management", desc: "Accounting and balance-sheet reporting software", icon: "BarChart3" },
      { title: "Process automation", desc: "Workflow automation for business efficiency", icon: "Zap" },
    ],
    visual: { label: "CoxDA Finance System", icon: "Database", image: "/images/case-studies/coxda-fms-dashboard.png" },
    relatedProjects: ["coxda"],
  },
  {
    id: "iot",
    ...
    icon: "Activity",
    color: "#1D9E75",
    description: "IoT device integration and real-time sensor data pipelines for field monitoring and automation.",
    features: [
      { title: "Device integration", desc: "Connecting field IoT sensors to cloud and mobile apps", icon: "Activity" },
      { title: "Real-time streaming", desc: "Live sensor data collection and processing", icon: "TrendingUp" },
      { title: "Smart monitoring", desc: "Automated alerts and dashboards from sensor networks", icon: "Cpu" },
    ],
    visual: { label: "I-Soil IoT Monitoring", icon: "Activity", image: "/images/projects/isoil-web.png" },
    relatedProjects: ["isoil"],
  },
  {
    id: "network-ict",
    name: "Network & ICT",
    ...
    icon: "Network",
    color: "#185FA5",
    description: "Enterprise networking, connectivity, and end-to-end ICT infrastructure solutions.",
    features: [
      { title: "Network infrastructure", desc: "Design, setup and optimization of enterprise networks", icon: "Network" },
      { title: "Connectivity & security", desc: "Reliable connectivity with security implementations", icon: "Server" },
      { title: "ICT solutions", desc: "Collaboration, communication and infrastructure services", icon: "Building2" },
    ],
    visual: { label: "BMD Network Infrastructure", icon: "Network", image: "/images/server/server-strength-grid.jpg" },
    relatedProjects: ["bmd"],
  },
]
